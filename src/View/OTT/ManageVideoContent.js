...
const ManageVideoContent = () => {
  ...
  console.log('watchfreeStatus', watchfreeStatus);
  ...
  const columns = [
    ...
    {
      name: <div style={{ fontSize: '14px', color: '#495057', fontWeight: 'bolder' }}>Thumbnail</div>,
      selector: row => row.thumbnailImage,
    },
    {
      name: <div style={{ fontSize: '14px', color: '#495057', fontWeight: 'bolder' }}>Content Type</div>,
      selector: row => row.contentType,
    },
    {
      name: <div style={{ fontSize: '14px', color: '#495057', fontWeight: 'bolder' }}>Production Name</div>,
      selector: row => row.productionName,
    },
    {
      name: <div style={{ fontSize: '14px', color: '#495057', fontWeight: 'bolder' }}>Title</div>,
      selector: row => row.showTitle,
    },
    {
      name: <div style={{ fontSize: '14px', color: '#495057', fontWeight: 'bolder' }}>Director Name</div>,
      selector: row => row.directorName,
    },

    {
      name: <div style={{ fontSize: '14px', color: '#495057', fontWeight: 'bolder' }}>Duration</div>,
      selector: row => row.duration,
    },

    {
      name: <div style={{ fontSize: '14px', color: '#495057', fontWeight: 'bolder' }}>Season</div>,

      selector: row => {
        if (row.contentType === 'ott') {
          return (
            <>
              <Link to={`/manage-season/${row.id}`}>Manage</Link>
            </>
          );
        }
      },
  ...
  const onEdit = item => {
    ...
    setWatchfreeStatus(String(item?.watchfreeStatus));
            ...
            <div className="main-card mb-3 card">
              <div className="card-body">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Create Content for :</label>
                  ...
                  <div class="form-check">
                    <input
                      ...
                      onClick={e => setContentType(e.target.name)}
                      checked={checkRadio(contentType, 'movie')}
                    />
                  ...
                  <div class="form-check">
                    <input
                      ...
                      onClick={e => setContentType(e.target.name)}
                      checked={checkRadio(contentType, 'ott')}
                    />
                ...
                <div class="form-group" style={{ display: contentType === '' && 'none' }}>
                  <div class="row" style={{ marginBottom: '1rem' }}>
                    <div class="col">
                      <label for="inputEmail4">Production name:</label>
                      <input
                        type="text"
                        class="form-control"
                  ...
                  <div class="row" style={{ marginBottom: '1rem' }}>
                    <div class="col">
                      <label for="inputEmail4">Cast Names:</label>
                      <div className="button-section mt-2">
                        <button className="btn btn-sm btn-primary" type="button" onClick={() => addFormFields()}>
                    ...
                    <div class="col">
                      ...
                      <select className="form-control" onChange={e => setOttCategoryID(e.target.value)}>
                        ...
                        {allOttCategoryID?.map((ele, id) => {
                          return (
                            <option selected={ele._id == ottCategoryID ? true : false} value={ele._id} key={ele._id}>
                              {ele.catName}
                            </option>
                          );
                        })}
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Watch free?</label>
                    ...
                    <div class="form-check">
                      <input
                        ...
                        id="flexRadioDefault1"
                        // onClick={e => {
                        //   setWatchfreeStatus(e.target.value);
                        // }}
                        onChange={e => {
                          setWatchfreeStatus(e.target.value);
                        }}
                        // checked={checkRadio(watchfreeStatus, true)}
                        checked={watchfreeStatus == 'true' ? true : false}
                      />
                      <label class="form-check-label" for="flexRadioDefault1">
                        Yes
                      </label>
                    ...
                    <div class="form-check">
                      <input
                        ...
                        // checked={checkRadio(watchfreeStatus, false)}
                        checked={watchfreeStatus == 'false' ? true : false}
                      />
                      <label class="form-check-label" for="flexRadioDefault2">
                        No
                      </label>
                  ...
                  <label for="exampleInputEmail1">Upload Tailer :</label>
                  <input
                    class="form-control"
                  ...
                  <div style={{ display: contentType === 'ott' && 'none', marginTop: '1rem' }}>
                    <label for="exampleInputEmail1">Upload Movie :</label>
                    <input
                      class="form-control"
